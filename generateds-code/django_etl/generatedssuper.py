...
from generateDS import AnyTypeIdentifier, mapName, cleanupName, fixDjangoName
...
class GeneratedsSuper(object):
    ...
    @classmethod
    def generate_model_(
            cls, wrtmodels, wrtforms,
            unique_name_map, class_suffixes,
            class_name_set, class_back_refs, simpletype_array_size):
        if class_suffixes:
            model_suffix = '_model'
            form_suffix = '_form'
        else:
